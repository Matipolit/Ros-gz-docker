...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input_file", required=True, help="Input point cloud path")
...
def main() -> int:
    ...
    print(
        f"Saved downsampled point cloud with {len(downsampled.points)} points to: {output_file}"
    )
    return 0
